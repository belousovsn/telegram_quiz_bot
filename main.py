...
client = Anthropic(api_key="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")

# Initialize the Tavily client
tavily = TavilyClient(api_key="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")
